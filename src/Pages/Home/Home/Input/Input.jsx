  ...
  return (
    <div>
      ...
      <section id="donate" className="my-10 md:my-40  dark:text-gray-900">
        <h1 className="text-4xl font-bold text-center pb-20">Donation Form</h1>
          ...
          <div className="py-6 md:py-0 md:px-6 space-y-8">
            ...
            <div>
              <p className="">
                ...
                <p>
                  Each donation can make a profound difference, with the
                  potential to save up to three lives. By giving just a little
                  of your time and blood, you provide hope and healing to
                  patients in need. Join us today – your act of kindness is
